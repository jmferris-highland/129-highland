...
| [`subsystems/LANDROID.md`](subsystems/LANDROID.md) | 🔄 Phase 1 Deployed | Worx Landroid Vision WR344 — autonomous mowing with solar-bounded window, rain suppression FSM, completion detection, Party Mode integration; edge cuts pending `landroid_cloud` fix |
